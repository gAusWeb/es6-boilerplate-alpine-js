    ...
    $(".accordion-custom .accordion-custom__item").each((i, el) => {
        if ($(el).attr("data-acc-cust") === "expanded") {
            ...
            const bodyHeight = $(el)
                ...
                .outerHeight();
            const initHeight =
                $(el).find(".accordion-custom__body").children().outerHeight() -
                10;
            $(el)
                .find(".accordion-custom__head")
                .first()
    ...
    $(".accordion-custom .accordion-custom__head").each(function () {
        $(this).on("click", function () {
            ...
            let activeAccordHeight = $(this)
                ...
                .outerHeight();
            activeAccordHeight =
                activeAccordHeight + clickedParentRestHeight - 10;

            // AUTO COLLAPSE GROUPING
            if (
                $(this).parent().parent().attr("data-acc-cust") ===
                "auto-toggle"
            ) {
                $(this)
                    .parent()
            ...
            if ($(this).attr("data-acc-cust-init-height") === undefined) {
                clickedParentRestHeight = $(this)
                    ...
                    .outerHeight();
                $(this).attr(
                    "data-acc-cust-init-height",
                    clickedParentRestHeight
                );
            } else {
            ...
            if ($(this).hasClass("accordion-head-active")) {
                if (
                    $(this).closest(".accordion-custom__body.accordion-active")
                ) {
                    $(this)
                        .closest(".accordion-custom__body.accordion-active")
                ...
                $(this).closest(".accordion-custom__item").removeAttr("style");
                $(this)
                    .siblings()
                    .removeAttr("style")
                    .removeClass("accordion-active");
